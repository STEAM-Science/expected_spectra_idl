...
FUNCTION gaussfold, lam, flux, fwhm, lammin=lammin, lammax=lammax, nointerpolate=nointerpolate
   ...
   IF (NOT KEYWORD_SET(nointerpolate)) THEN BEGIN
    dlambda   = fwhm / 17D0
   ...
   window   = FIX( 17 * fwhm_pix ) < n_elements(interlam)
   ...
   IF (NOT KEYWORD_SET(nointerpolate)) THEN $
